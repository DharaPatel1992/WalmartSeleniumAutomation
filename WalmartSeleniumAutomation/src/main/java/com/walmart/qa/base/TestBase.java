...
import com.walmart.qa.util.WebEventListener;
	...
	public TestBase() {
		...
		try {
			FileInputStream ip = new FileInputStream(
					"C:\\Users\\Dhara Patel\\git\\WalmartSeleniumAutomation\\WalmartSeleniumAutomation\\src\\main\\java\\com\\walmart\\qa\\config\\config.properties");
			prop.load(ip);
